...
created_at: '2026-05-20T03:12:29+09:00'
status: active
...
# E0042: FB0054-support-squash-rebase-merge-methods-in-github-flow-merge を評価

## フィクスチャ

- source_feedback: `harness-lab/records/feedback/FB0054-support-squash-rebase-merge-methods-in-github-flow-merge.md`
- fixture_dir: `harness-lab/records/eval-cases/fixtures/E0042`
...
- `hops lab eval --case E0042 --manual` の score と notes で採用判断に必要な証拠を説明できる。
